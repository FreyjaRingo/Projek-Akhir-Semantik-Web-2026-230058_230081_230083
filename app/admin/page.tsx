...
const navItems = [
  ...
  { title: 'Semantic Path', description: 'Find relationship paths between anime.', href: '/admin/path', icon: GitBranch },
  { title: 'Graph Visualization', description: 'Interactive RDF knowledge graph explorer.', href: '/admin/graph', icon: Database },
